...
public class reportsonmy_adopteddogs_adapter_shelter extends RecyclerView.Adapter<reportsonmy_adopteddogs_adapter_shelter.ViewHolder>{
    ...
    public reportsonmy_adopteddogs_adapter_shelter(List<reportsonmyadopteddog_data> listItems, Context context) {
        this.listItems = listItems;
        this.context = context;
    }

    @Override
    public reportsonmy_adopteddogs_adapter_shelter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.myreports_adopteddogs_cards_shelter, parent, false);
        return new reportsonmy_adopteddogs_adapter_shelter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(reportsonmy_adopteddogs_adapter_shelter.ViewHolder holder, int position) {
...
//        holder.ime.setText(listItem.getIme());
        ...
        SharedPreferences sp1=reportsonmy_adopteddogs_adapter_shelter.this.context.getSharedPreferences("userdata", Context.MODE_PRIVATE);
        ...
        holder.moreadopteddog_adapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                reportsonmyadopteddog_dialog_shelter dialog=new reportsonmyadopteddog_dialog_shelter();
                dialog.show(manager, "myreportsmissingdogshelter");
            }
        });
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            moreadopteddog_adapter=(Button) itemView.findViewById(R.id.more_adopteddog_adapter_shelter);
        }
    }
