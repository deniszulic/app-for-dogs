...
public class nestalipsi_oglasi_azil_azil extends Fragment {
    ...
    public nestalipsi_oglasi_azil_azil() {
        // Required empty public constructor
    }
    public static nestalipsi_oglasi_azil_azil newInstance(String param1, String param2) {
        nestalipsi_oglasi_azil_azil fragment = new nestalipsi_oglasi_azil_azil();
        ...
        data.enqueue(new Callback<Missingdogs_user_shelter_data[]>() {
            ...
            public void onResponse(Call<Missingdogs_user_shelter_data[]> call, Response<Missingdogs_user_shelter_data[]> response) {
                try{
                    ...
                    adapter = new Missingdogs_shelter_adapter(listItems, getContext());
