...
public class reportsonmymissingdogs_adapter_shelter extends RecyclerView.Adapter<reportsonmymissingdogs_adapter_shelter.ViewHolder>{
    ...
    public reportsonmymissingdogs_adapter_shelter(List<reportsonmymissingdogsdata> listItems, Context context) {
        this.listItems = listItems;
        this.context = context;
    }

    @Override
    public reportsonmymissingdogs_adapter_shelter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.reportsonmymissingdogs_cards, parent, false);
        return new reportsonmymissingdogs_adapter_shelter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(reportsonmymissingdogs_adapter_shelter.ViewHolder holder, int position) {
        ...
        SharedPreferences sp1=reportsonmymissingdogs_adapter_shelter.this.context.getSharedPreferences("userdata", Context.MODE_PRIVATE);
        ...
        holder.more_reportsonmymissingdog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                reportsonmymissingdog_dialog_shelter dialog=new reportsonmymissingdog_dialog_shelter();
