...
public class reportsonmy_adopteddogs extends Fragment {
    ...
    public reportsonmy_adopteddogs() {
        // Required empty public constructor
    }
    public static reportsonmy_adopteddogs newInstance(String param1, String param2) {
        reportsonmy_adopteddogs fragment = new reportsonmy_adopteddogs();
...
//        return inflater.inflate(R.layout.fragment_reportsonmy_adopteddogs, container, false);
        View v= inflater.inflate(R.layout.fragment_reportsonmy_adopteddogs, container, false);
        ...
        recyclerView = (RecyclerView) v.findViewById(R.id.prijavenamojiudomljenipsi);
        ...
        data.enqueue(new Callback<reportsonmyadopteddog_data[]>() {
            ...
            public void onResponse(Call<reportsonmyadopteddog_data[]> call, Response<reportsonmyadopteddog_data[]> response) {
                if(response.code()==200) {
                    ...
                    adapter= new reportsonmy_adopteddogs_adapter(listItems, getContext());
