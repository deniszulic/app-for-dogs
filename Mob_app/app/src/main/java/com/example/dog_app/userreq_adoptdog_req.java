...
public class userreq_adoptdog_req extends Fragment {
    ...
    public userreq_adoptdog_req() {
        // Required empty public constructor
    }

    public static userreq_adoptdog_req newInstance(String param1, String param2) {
        userreq_adoptdog_req fragment = new userreq_adoptdog_req();
...
//        return inflater.inflate(R.layout.fragment_userreq_adoptdog_req, container, false);
        ...
        Call<userreq_adoptdog_data[]> data = retrofitInterface.userreqadoptdogreq(getemail);
