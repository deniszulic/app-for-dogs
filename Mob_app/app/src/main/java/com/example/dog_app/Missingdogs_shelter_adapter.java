...
public class Missingdogs_shelter_adapter extends RecyclerView.Adapter<Missingdogs_shelter_adapter.ViewHolder>{
    ...
    public Missingdogs_shelter_adapter(List<Missingdogs_user_shelter_data> listItems, Context context) {
        this.listItems = listItems;
        this.context = context;
    }

    @Override
    public Missingdogs_shelter_adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_user_shelter, parent, false);
        return new Missingdogs_shelter_adapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(Missingdogs_shelter_adapter.ViewHolder holder, int position) {
...
//                SharedPreferences sp1=context.getSharedPreferences("userdata", Context.MODE_PRIVATE);
                ...
                Intent i=new Intent(context, komentari_shelter.class);
                i.putExtra("id", listItem.getId());
                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                context.startActivity(i);
            }
        });
        SharedPreferences sp1=Missingdogs_shelter_adapter.this.context.getSharedPreferences("userdata", Context.MODE_PRIVATE);
    ...
    public static void setEmail_azila(String email_azila) {
        Missingdogs_shelter_adapter.email_azila = email_azila;
    }
