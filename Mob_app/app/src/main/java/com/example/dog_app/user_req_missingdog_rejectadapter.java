...
public class user_req_missingdog_rejectadapter extends RecyclerView.Adapter<user_req_missingdog_rejectadapter.ViewHolder>{
    ...
    public user_req_missingdog_rejectadapter(List<userreq_missingdog_data> listItems, Context context) {
        this.listItems = listItems;
        this.context = context;
    }

    @Override
    public user_req_missingdog_rejectadapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_missingdog_req, parent, false);
        return new user_req_missingdog_rejectadapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(user_req_missingdog_rejectadapter.ViewHolder holder, int position) {
        ...
        holder.potvrdaoglasa_nestalipsi_korisnik_item_userreq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                missingdog_userreject_dialog dialog=new missingdog_userreject_dialog();
                dialog.show(manager, "mymissingdogs");
            }
        });
        SharedPreferences sp1=user_req_missingdog_rejectadapter.this.context.getSharedPreferences("userdata", Context.MODE_PRIVATE);
