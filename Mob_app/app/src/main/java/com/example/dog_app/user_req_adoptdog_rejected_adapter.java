...
public class user_req_adoptdog_rejected_adapter extends RecyclerView.Adapter<user_req_adoptdog_rejected_adapter.ViewHolder>{
    ...
    public user_req_adoptdog_rejected_adapter(List<userreq_adoptdog_data> listItems, Context context) {
        this.listItems = listItems;
        this.context = context;
    }

    @Override
    public user_req_adoptdog_rejected_adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_adoptdog_req, parent, false);
        return new user_req_adoptdog_rejected_adapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(user_req_adoptdog_rejected_adapter.ViewHolder holder, int position) {
        ...
        holder.potvrdaoglasa_nestalipsi_korisnik_item_userreq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                adopteddog_userrejected_dialog dialog=new adopteddog_userrejected_dialog();
                dialog.show(manager, "userreqadopteddog");
            }
        });
        SharedPreferences sp1=user_req_adoptdog_rejected_adapter.this.context.getSharedPreferences("userdata", Context.MODE_PRIVATE);
