...
public class userreq_mis_reject extends Fragment {
    ...
    public userreq_mis_reject() {
        // Required empty public constructor
    }

    public static userreq_mis_reject newInstance(String param1, String param2) {
        userreq_mis_reject fragment = new userreq_mis_reject();
...
//        return inflater.inflate(R.layout.fragment_userreq_mis_reject, container, false);
        ...
        recyclerView = (RecyclerView) v.findViewById(R.id.userrequest_missingdog_reject);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        SharedPreferences sp=getActivity().getSharedPreferences("userdata", Context.MODE_PRIVATE);
        String getemail=sp.getString("email", null);
        Call<userreq_missingdog_data[]> data = retrofitInterface.userreqmissingdogrejected(getemail);
        ...
        data.enqueue(new Callback<userreq_missingdog_data[]>() {
            ...
            public void onResponse(Call<userreq_missingdog_data[]> call, Response<userreq_missingdog_data[]> response) {
                if(response.code()==200) {
                    ...
                    adapter= new user_req_missingdog_rejectadapter(listItems, getContext());
