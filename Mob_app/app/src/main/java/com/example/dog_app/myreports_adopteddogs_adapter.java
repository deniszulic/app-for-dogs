...
public class myreports_adopteddogs_adapter extends RecyclerView.Adapter<myreports_adopteddogs_adapter.ViewHolder>{
    ...
    private static String useremail, ime, prezime, adresa, grad, postnum, kontakt, imepsa, pasmina,
            ...
            naziv_azila, grad_azila, prihvaceno, ime_udomljavanje, prezime_udomljavanje, adresa_udomljavanje,
    ...
    public myreports_adopteddogs_adapter(List<myreportsadopteddogs_data> listItems, Context context) {
        this.listItems = listItems;
        this.context = context;
    }

    @Override
    public myreports_adopteddogs_adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.myreports_adopteddogs_cards, parent, false);
        return new myreports_adopteddogs_adapter.ViewHolder(v);
    }
...
//        holder.ime.setText(listItem.getIme());
        ...
        SharedPreferences sp1=myreports_adopteddogs_adapter.this.context.getSharedPreferences("userdata", Context.MODE_PRIVATE);
...
//                datumizgubljen=listItem.getDatum_izgubljen();
                ...
                ime_udomljavanje=listItem.getIme_udomljavanje();
                prezime_udomljavanje=listItem.getPrezime_udomljavanje();
                adresa_udomljavanje=listItem.getAdresa_udomljavanje();
                grad_udomljavanje=listItem.getGrad_udomljavanje();
                postanski_broj_udomljavanje=listItem.getPostanski_broj_udomljavanje();
                kilaza=listItem.getKilaza();
                kastrat=listItem.getKastrat();
                opasnost=listItem.getOpasnost();
                napomena_udomljavanje=listItem.getNapomena_udomljavanje();
                FragmentManager manager = ((AppCompatActivity)context).getSupportFragmentManager();
                myreports_adopteddogs_dialog dialog=new myreports_adopteddogs_dialog();
