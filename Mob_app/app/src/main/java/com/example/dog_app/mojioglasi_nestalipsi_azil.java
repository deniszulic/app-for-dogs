...
public class mojioglasi_nestalipsi_azil extends Fragment {
    ...
    public mojioglasi_nestalipsi_azil() {
        // Required empty public constructor
    }
    public static mojioglasi_nestalipsi_azil newInstance(String param1, String param2) {
        mojioglasi_nestalipsi_azil fragment = new mojioglasi_nestalipsi_azil();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_mojioglasi_nestalipsi_azil, container, false);
        ...
        recyclerView = (RecyclerView) v.findViewById(R.id.mojioglasi_nestalipsi_azil);
        ...
        data.enqueue(new Callback<mymissingdogsdata[]>() {
            ...
            public void onResponse(Call<mymissingdogsdata[]> call, Response<mymissingdogsdata[]> response) {
                ...
                adapter = new mymissingdogsadapter_shelter(listItems, getContext());
