...
public class user_req_missingdog_adopadapter extends RecyclerView.Adapter<user_req_missingdog_adopadapter.ViewHolder>{
...
//    private static String useremail;
    ...
    @Override
    public user_req_missingdog_adopadapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_missingdog_req, parent, false);
        return new user_req_missingdog_adopadapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(user_req_missingdog_adopadapter.ViewHolder holder, int position) {
        ...
        holder.potvrdaoglasa_nestalipsi_korisnik_item_userreq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                missingdog_useradopt_dialog dialog=new missingdog_useradopt_dialog();
                dialog.show(manager, "mymissingdogs");
            }
        });
        SharedPreferences sp1=user_req_missingdog_adopadapter.this.context.getSharedPreferences("userdata", Context.MODE_PRIVATE);
