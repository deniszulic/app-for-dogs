...
public class userreq_adoptdog_reject extends Fragment {
    ...
    public userreq_adoptdog_reject() {
        // Required empty public constructor
    }

    public static userreq_adoptdog_reject newInstance(String param1, String param2) {
        userreq_adoptdog_reject fragment = new userreq_adoptdog_reject();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<userreq_adoptdog_data[]> data = retrofitInterface.updatereportadopteddogreject(getemail);
            ...
            public void onResponse(Call<userreq_adoptdog_data[]> call, Response<userreq_adoptdog_data[]> response) {
                if(response.code()==200) {
                    try{
                        ...
                        adapter= new user_req_adoptdog_rejected_adapter(listItems, getContext());
