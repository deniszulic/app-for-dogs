...
public class reportsonmyad extends Fragment {
    ...
    public reportsonmyad() {
        // Required empty public constructor
    }
    public static reportsonmyad newInstance(String param1, String param2) {
        reportsonmyad fragment = new reportsonmyad();
...
//        return inflater.inflate(R.layout.fragment_reportsonmyad, container, false);
        View v= inflater.inflate(R.layout.fragment_reportsonmyad, container, false);
        ...
        recyclerView = (RecyclerView) v.findViewById(R.id.reportonmymisingdogs);
        ...
        data.enqueue(new Callback<reportsonmymissingdogsdata[]>() {
            ...
            public void onResponse(Call<reportsonmymissingdogsdata[]> call, Response<reportsonmymissingdogsdata[]> response) {
                if(response.code()==200) {
                    ...
                    adapter= new reportsonmymissingdogs_adapter(listItems, getContext());
