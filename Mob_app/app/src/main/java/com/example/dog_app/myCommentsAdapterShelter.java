...
public class myCommentsAdapterShelter extends RecyclerView.Adapter<myCommentsAdapterShelter.ViewHolder> {

    private List<Comments> commentsList;
    private Retrofit retrofit;
    private RetrofitInterface retrofitInterface;
    private String BASE_URL = "http://10.0.2.2:3000";
    myCommentsAdapterShelter adapter;
    private int id;

    public myCommentsAdapterShelter(List<Comments> commentsList, int id) {
    ...
    @Override
    public void onBindViewHolder(myCommentsAdapterShelter.ViewHolder holder, int position) {
