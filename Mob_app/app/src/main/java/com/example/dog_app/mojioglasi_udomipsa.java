...
public class mojioglasi_udomipsa extends Fragment {
    ...
    public mojioglasi_udomipsa() {
        // Required empty public constructor
    }

    public static mojioglasi_udomipsa newInstance(String param1, String param2) {
        mojioglasi_udomipsa fragment = new mojioglasi_udomipsa();
...
//        return inflater.inflate(R.layout.fragment_mojioglasi_udomipsa, container, false);
        View v= inflater.inflate(R.layout.fragment_mojioglasi_udomipsa, container, false);
        ...
        recyclerView = (RecyclerView) v.findViewById(R.id.mojioglasi_udomipsa);
