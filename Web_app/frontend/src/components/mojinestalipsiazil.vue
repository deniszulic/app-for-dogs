  ...
  <div>
        ...
        <div class="postcard__text t-dark">
          ...
          <div class="d-flex justify-content-center">
            ...
            <button
              ...
              @click="$emit('changedata_missingdog', data)"
              style="margin-right: 10px"
            >
              Promjena podataka
            </button>
      ...
      <article class="postcard light blue" v-if="showcomments">
        ...
        <div class="postcard__text t-dark">
          ...
          <div class="postcard__subtitle small">
            <time>
              <i class="fas fa-calendar-alt mr-2"></i>Postavljeno:
              {{ moment(parseInt(data[0].postavljeno)).format("lll") }}
            </time>
          </div>
          <div class="postcard__bar"></div>
          <div class="postcard__preview-txt">
          ...
          <div class="comments list-group"></div>
        </div>
      </article>
      <div
        class="modal fade"
    ...
    >
      <div class="d-flex w-100 justify-content-between">
        ...
        <a @click="deletecom(a.id)" href="javascript:void(0)">Obriši</a>
      </div>
      {{ a.komentar }}
    </a>
    <form
...
export default {
  ...
  methods: {
    opencard(data) {
      this.$router.push({ path: `mojioglasiazil/${data}` });
    },
    openimg(data) {
      this.url = data;
