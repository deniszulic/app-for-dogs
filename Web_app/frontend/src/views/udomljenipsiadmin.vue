    ...
    <div class="tab-content" id="pills-tabContent">
      ...
      >
        <udomljenipsiadmintablicaazil
          :data="missingdogsshelter"
          @myreportmissingdog="openmodalshelter"
          :search="search"
        />
      </div>
    </div>

    <div class="modal fade" id="missingdogadmin" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="number" class="form-control" v-model="starost" />
              </div>
            </div>
            <div class="form-group">
              <div class="input-group">
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="number" class="form-control" v-model="kilaza" />
              </div>
            </div>
            <div class="form-group">
              <div class="input-group">
          ...
          <div class="modal-footer">
            ...
            <button
              ...
              @click="updatedatamissingdoguser"
            >
              Spremi
            </button>
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="">Naziv ambulante</span>
                </div>
                <input
                  type="text"
                  class="form-control"
...
export default {
  ...
  methods: {
    ...
    async deletedata() {
      try {
        await dog_data.deleteadopted(this.id).then(() => {
          $("#missingdogadmin").modal("hide");
          $("#missingdogadminshelter").modal("hide");
          this.getdata();
          this.getdatashelter();
