...
<div class="row">
    <div class="col-md">
    <form class="background rounded" @submit.prevent="addadmin" style="margin-bottom:10px;background-color:	#404040;">
      <h1 style="color:white;">Dodaj admina</h1>
      <div class="form-group">
        <label for="name" style="color:white;">Ime</label>
        <input
          type="text"
          class="form-control" v-model="ime_register" style="color:white;"
        />
      </div>
      <div class="form-group">
        <label for="surname" style="color:white;">Prezime</label>
        <input
          type="text"
          class="form-control" v-model="prezime_register" style="color:white;"
        />
      </div>
      <div class="form-group">
        ...
        <input
          type="text"
          class="form-control" v-model="email_register" style="color:white;"
        />
      </div>
      <div class="form-group">
        ...
        <input
          type="password"
          class="form-control" v-model="lozinka_register" style="color:white;"
        />
      </div>
